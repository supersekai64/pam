...
signals. Proposed duplicates are merged, active matches become proposed
supersessions in assisted mode, and auto mode can supersede directly. The
Markdown source remains auditable through `supersedes` and `source_ids`.
